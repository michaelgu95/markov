...
;
    ...
    public void testHashEquals(){
    	...
    	assertEquals("hash fail on equals 0,6",myNgrams[0].hashCode(),myNgrams[6].hashCode());
    	assertEquals("hash fail on equals 1,4",myNgrams[1].hashCode(),myNgrams[4].hashCode());
    	assertEquals("hash fail on equals 2,8",myNgrams[2].hashCode(),myNgrams[8].hashCode());
    	assertEquals("hash fail on equals 2,5",myNgrams[2].hashCode(),myNgrams[5].hashCode());
    }
